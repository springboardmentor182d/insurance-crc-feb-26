...
class UserPreferences(Base):
    ...
    promotional_emails: Mapped[bool] = mapped_column(
        Boolean, default=False, nullable=False
    )
    ...
    biometric_login: Mapped[bool] = mapped_column(
        Boolean, default=False, nullable=False
    )
    ...
    date_format: Mapped[str] = mapped_column(
        String, default="MM/DD/YYYY", nullable=False
    )

    share_data_with_partners: Mapped[bool] = mapped_column(
        Boolean, default=False, nullable=False
    )
