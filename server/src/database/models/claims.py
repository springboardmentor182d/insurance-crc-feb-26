...
from sqlalchemy import DateTime, Enum as SQLEnum, Float, ForeignKey, Integer, Numeric, String, Text, func
...
class Claim(Base):
    ...
    adjuster: Mapped["Adjuster | None"] = relationship("Adjuster", back_populates="claims")
