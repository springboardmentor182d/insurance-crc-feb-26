      ...
      {view === 'dashboard' ? (
        <div className="animate-in fade-in duration-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            <div className="bg-purple-600 p-8 rounded-3xl text-white flex justify-between items-center">
              <div className="text-left">
            ...
            <div
              ...
              className="bg-green-600 p-8 rounded-3xl text-white flex justify-between items-center cursor-pointer"
            >
              <div className="text-left">
                <h4 className="text-xl font-bold mb-1">File a Claim</h4>
                <p className="text-green-100 text-sm">
                  Quick and easy claim submission
                </p>
              </div>
              <Plus size={28} />
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div className="space-y-4">
                {policies.map((policy, i) => (
                  <div
                    key={i}
                    className="flex justify-between items-center p-4 bg-gray-50 border border-gray-100 rounded-2xl"
                  >
                    <div>
        ...
        <div className="max-w-2xl mx-auto bg-white p-10 rounded-3xl border border-gray-100 shadow-xl text-left">
          <button
            ...
            className="flex items-center text-blue-600 mb-8 font-bold text-xs"
          >
